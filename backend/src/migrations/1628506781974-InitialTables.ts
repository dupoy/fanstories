...
export class InitialTables1628506781974 implements MigrationInterface {
    name = 'InitialTables1628506781974'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "stories" ("id" SERIAL NOT NULL, "slug" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "words" integer NOT NULL DEFAULT '0', "rating" "stories_rating_enum" NOT NULL, "focus" "stories_focus_enum" NOT NULL, "status" "stories_status_enum" NOT NULL, "favoriteCount" integer NOT NULL, "followCount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" integer, CONSTRAINT "PK_bb6f880b260ed96c452b32a39f0" PRIMARY KEY ("id"))`);
